		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="issueInput.jsp">Issue Input</a></li>
				</ul>

			</div>
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">Issue Input</h1>


				<form class="form form-vertical" action="compareIssue"
					id="submitScript">
					<div class="control-group">
						<label>Browse File</label>
						<div class="controls">
							<input type="file" class="form-control"
								placeholder="Script File Name" name="filePath">
