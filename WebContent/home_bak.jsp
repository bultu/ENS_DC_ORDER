      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">
            <i class="glyphicon glyphicon-user"></i> DC Order <span class="caret"></span></a>
...
<div class="container">
      ...
      <!-- column 2 -->	
	   ...
	   <div class="row">
        	...
        	<div class="col-md-5">
				...
				<p>
                  This is internal portal for management of DC Order Issues. You can use this portal to create and submit fixes for issues assigned to your CUID.
                </p>
                <p>
                  Contact Kunal Joshi/Vishal Garg for any doubts regarding issues.
                </p>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <hr>
      <a href="#"><strong><i class="glyphicon glyphicon-list-alt"></i> Issues</strong></a>  
      <hr>    
    </div>
    <div class="col-md-8">
      ...
      <table class="table table-striped">
        <thead>
          <tr><th>Issue ID</th><th>Issue Description</th><th>Recurrance</th><th>Developer</th></tr>
        </thead>
        <tbody>
          <tr><td>1</td><td>IPV_with_no_pend_ord(313029343,1014684768,906783418);</td><td>3</td><td>Anurag</td></tr>
          <tr><td>2</td><td>unknown(436143812,1228279117,914738312);</td><td>1</td><td>Kunal</td></tr>
          <tr><td>3</td><td>dom_gt_curver_omprod(310176741,1226836872,898794422);</td><td>3</td><td>Vishal</td></tr>
          <tr><td>4</td><td>Ban_Level_PP_does_not_exists(437017913,1228042707,915036731);</td><td>2</td><td>Prateek</td></tr>
          <tr><td>5</td><td>IPV_with_no_pend_ord(313029343,1014684768,906783418);</td><td>3</td><td>Anurag</td></tr>
          <tr><td>6</td><td>unknown(436143812,1228279117,914738312);</td><td>5</td><td>Kunal</td></tr>
          <tr><td>7</td><td>dom_gt_curver_omprod(310176741,1226836872,898794422);</td><td>3</td><td>Vishal</td></tr>
          <tr><td>8</td><td>Ban_Level_PP_does_not_exists(437017913,1228042707,915036731);</td><td>3</td><td>Prateek</td></tr>
        </tbody>
      </table>
